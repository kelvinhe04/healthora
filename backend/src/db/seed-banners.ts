...
const DEFAULT_BANNERS = [
  {
    ...
    titleEn: '25% OFF on {categoria} products',
    kickerEn: 'Featured promotion',
    highlightWordEn: '',
    descriptionEn: 'Applies to {categoria} products. Valid from {fechaDesde} to {fechaHasta} with code PIEL25.',
    ctaTextEn: 'Shop {categoria}',
  ...
  },
  {
    ...
    titleEn: 'A free sample on premium orders',
    kickerEn: 'Healthora Club',
    highlightWordEn: 'free',
    descriptionEn: 'Sign up and get 1 selected sample on purchases over $200.',
    ctaTextEn: 'Join the club',
    ctaHref: '/club',
    categoryId: null,
