...
export function Icon({ name, size = 18, stroke = 'currentColor', style }: IconProps) {
  ...
  switch (name) {
    ...
    case 'package': return <svg {...common}><path d="M21 8 12 3 3 8v8l9 5 9-5V8Z"/><path d="M3 8l9 5 9-5"/><path d="M12 13v8"/></svg>;
    case 'layers': return <svg {...common}><path d="M12 2 2 7l10 5 10-5-10-5Z"/><path d="m2 12 10 5 10-5"/><path d="m2 17 10 5 10-5"/></svg>;
    ...
    case 'ban': return <svg {...common}><circle cx="12" cy="12" r="9"/><path d="m5.6 5.6 12.8 12.8"/></svg>;
    ...
    case 'credit-card': return <svg {...common}><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M2 10h20"/></svg>;
    default: return null;
  }
}
