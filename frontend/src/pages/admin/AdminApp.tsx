        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        Debes iniciar sesión con una cuenta autorizada como
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        Acceso{" "}
                        <em style={{ color: "var(--coral)" }}>denegado</em>
                    </h1>
                    <p
                        style={{
                            marginTop: 16,
...
function AdminPanel({
    ...
    const bulkDeleteMutation = useMutation({
        mutationFn: async (ids: string[]) => {
            ...
            await Promise.all(
                ids.map((id) => api.admin.products.remove(id, token)),
            );
        },
        onSuccess: (_, ids) => {
            invalidateProducts();
                            ...
                            >
                                {fulfillmentStatusOptions.map((status) => (
                                    <button
                                        key={status}
                                        onClick={() =>
                                            setOrderFulfillmentFilter(status)
                                        }
                                        style={{
                                            padding: "7px 14px",
                                            borderRadius: 999,
                    ...
                    <>
                        ...
                        {productModal && (
                            <ProductModal
                                ...
                                saving={isSaving}
                                error={
                                    (productCreateMutation.error as Error)
                                        ?.message ||
                                    (productUpdateMutation.error as Error)
                                        ?.message
                                }
                            />
                        )}
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ¿Eliminar a {confirmUserDelete.name}
                                            ? Esto eliminará su cuenta local. El
                                            usuario seguirá existiendo en Clerk.
                                        </p>
                                    </div>
                                    <div
                                        style={{
                    ...
                    <>
                        ...
                        >
                            ...
                            <KpiCard
                                ...
                                value={
                                    sales?.summary?.totalUnits?.toLocaleString() ??
                                    "—"
                                }
