/** Couriers comunes en envios de Panama, con su plantilla de URL de rastreo publica.
 * Espejo de backend/src/lib/tracking.ts. Un carrier fuera de esta lista (texto libre) simplemente
 * no muestra enlace, solo el numero. */
...
export const CARRIER_OPTIONS: { id: CarrierId; label: string }[] = (
  Object.entries(CARRIERS) as [CarrierId, (typeof CARRIERS)[CarrierId]][]
